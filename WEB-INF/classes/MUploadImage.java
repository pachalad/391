...
public class MUploadImage extends HttpServlet {
	...
	try {
	    ...
	    //Get the image stream	
	    	InputStream instream = items[k].getInputStream();
	    ...
	    // Note that you must use "FOR UPDATE" in the select statement
	    	...
	    	rset.next();
	    	BLOB mypictureblob = ((OracleResultSet)rset).getBLOB("PHOTO");
	    	BLOB mythumbnailblob = ((OracleResultSet)rset).getBLOB("THUMBNAIL");
