	...
	*/
		...
		// users home page.
	        if(passwd.equals(truepwd)){
		        ...
		        response.sendRedirect("main_page.jsp?user="+userName);
	            ...
	            out.println("<input type=submit name=bSubmit value=Login><br>");
	            //out.println("<input type=submit name=bRegister value=Register>");
	            out.println("</CENTER></form>");
		        out.println("</CENTER></form>");
				out.println("<Center>");
				out.println("<FORM METHOD = link ACTION = create_account.html>");
